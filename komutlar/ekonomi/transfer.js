...
$onlyIf[$userExists[$mentioned[1]]!=undefined;{newEmbed:{description:Bir kullanıcı etiketlemelisin.}{color:RED}}]
$onlyIf[$mentioned[1]!=;{newEmbed:{description:Bir kullanıcı etiketlemelisin.}{color:RED}}]
